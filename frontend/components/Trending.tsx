...
function Trending() {
  ...
  return (
    <div className="flex flex-col col-span-full xl:col-span-2 bg-white shadow-lg rounded-sm bord border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100 flex items-center">
        ...
        <Info className="ml-2" containerClassName="min-w-44">
          <div className="text-sm text-center">
            Keeps track of the most frequently traded Cryptocurrency in your
            watchlist over the last minute.
          </div>
        </Info>
      </header>
      <div className="p-3">
