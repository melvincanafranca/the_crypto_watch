  ...
  return (
    <>
      ...
      >
        <div
          ref={modalContent}
          className="bg-white overflow-auto max-w-2xl w-full max-h-full rounder shadow-lg"
        >
          <form
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                type="search"
                placeholder="Search for a symbol (e.g. BTC"
                ref={searchInput}
                onChange={async (e) => {
                  e.preventDefault();
              ...
              >
                <svg
                  className="w-4 h-4 shrink-0 fill-current text-slate-400 group-hover:text-slate-500 m-4 mr-2"
                  viewBox="0 0 16 16"
